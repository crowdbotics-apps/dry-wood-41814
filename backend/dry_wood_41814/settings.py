"""
Django settings for dry_wood_41814 project.
...
ROOT_URLCONF = 'dry_wood_41814.urls'
...
WSGI_APPLICATION = 'dry_wood_41814.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_wood_41814 API",
    "DESCRIPTION": "API documentation for dry_wood_41814 App",
    "VERSION": "v1",
}
